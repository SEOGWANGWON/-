...
export default function FreshTossCheckout() {
  ...
  return (
    <div className="freshwrapper freshw-100">
      <div className="freshmax-w-540 freshw-100">
        <div id="payment-method" className="freshw-100" />
        <div id="agreement" className="freshw-100" />
        <div className="btn-wrapper freshw-100">
          <button
            className="freshbtn freshprimary freshw-100"
            onClick={async () => {
