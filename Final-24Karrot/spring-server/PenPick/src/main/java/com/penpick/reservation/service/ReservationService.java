...
public class ReservationService{
  ...
  //24시간 이후 데이터 가져오기
    ...
    public void makeReservation(String email,String phoneNumber,int people,String pick,String payment,int pay,Date checkInDay,Date checkOutDay,String roomType)  {
