...
public class FreshOrderItemController {
	...
	@GetMapping("/FreshOrderItemIds")
	 public List<FreshOrderItem> getReservation(@RequestParam Long id){
		 List<FreshOrderItem> freshOrderItemList = freshorderitemService.findFreshOrderItemById(id);
		 return freshOrderItemList;
	 }
	
	
	//유저와 맞는 주문 불러오기
//	@GetMapping("/FreshOrderItemIds")
//	public List<FreshOrderItem> getReservationsById(@RequestParam("id") Long id) {
//	    return freshorderitemService.findFreshOrderItemById(id);
//	}
